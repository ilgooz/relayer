...
LD_FLAGS = -X github.com/ilgooz/relayer/cmd.Version=$(VERSION) \
	-X github.com/ilgooz/relayer/cmd.Commit=$(COMMIT) \
	-X github.com/ilgooz/relayer/cmd.SDKCommit=$(SDKCOMMIT) \
	-X github.com/ilgooz/relayer/cmd.GaiaCommit=$(GAIACOMMIT)
